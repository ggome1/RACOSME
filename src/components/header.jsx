...
const Header = () => {
  return (
    <div className="absolute bg-white min-h-[90px] min-w-full flex flex-col py-4 rounded-b-2xl shadow-lg whitespace-nowrap overflow-visible">
      <div className="flex justify-center items-center gap-20 h-full px-8">
        <img className="w-[200px]" src={`${process.env.PUBLIC_URL}/images/logo.png`} alt="Banner" />
